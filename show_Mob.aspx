<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show_Mob.aspx.cs" Inherits="masterpage3.mob" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Mobile.aspx" style="text-decoration: none;border: 1px solid black; padding: 5px;" Font-Bold="True" CssClass="auto-style3 hyperlink-hover" >Continue Shopping</asp:HyperLink>
        <br />
        <br />
        <br />
        <br />
